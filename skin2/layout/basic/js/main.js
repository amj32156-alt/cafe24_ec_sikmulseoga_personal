...
jQuery(document).ready(function () {
     ...
     var pick_slide = new Swiper('#pick .swiper', {
		slidesPerView: 1.12,
		spaceBetween: 10,
		observer: true,
		observeParents: true,
		...
		scrollbar: {
			el: "#pick .swiper-scrollbar",
			hide: false,
			draggable: true,
		},
		navigation: {
			nextEl: '#pick .swiper-button-next-special_slide',
			prevEl: '#pick .swiper-button-prev-special_slide',
		},
		//autoplay: {
			//delay: 5000,
    ...
    var review_slide = new Swiper('#review .swiper', {
		slidesPerView: 1.12,
		spaceBetween: 10,
		observer: true,
		observeParents: true,
		...
		navigation: {
			nextEl: '#review .swiper-button-next-special_slide',
			prevEl: '#review .swiper-button-prev-special_slide',
		},
		//autoplay: {
			//delay: 5000,
			//disableOnInteraction: false,
